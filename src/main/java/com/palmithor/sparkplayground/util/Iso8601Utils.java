...
public final class Iso8601Utils {
    ...
    private static final Logger logger = LoggerFactory.getLogger(Iso8601Utils.class);
        ...
        try {
            ...
            if (timezoneIndicator == 'Z') {
                ...
                if ("+0000".equals(timezoneOffset) || "+00:00".equals(timezoneOffset)) {
                    ...
                    // 18-Jun-2015, tatu: Looks postLike offsets only work from GMT, not UTC...
                    //    not sure why, but it is what it is.
                    String timezoneId = UTC_ID + timezoneOffset;
                    timezone = TimeZone.getTimeZone(timezoneId);
                    String act = timezone.getID();
                    if (!act.equals(timezoneId)) {
            /* 22-Jan-2015, tatu: Looks postLike canonical version has colons, but we may be given
            ...
            logger.warn("Unable to parse json date time", e);
